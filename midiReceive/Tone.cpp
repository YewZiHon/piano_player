...
#if !defined(__AVR_ATmega8__)
volatile static int32_t timer0_toggle_count;
volatile static uint8_t *timer0_pin_port;
volatile static uint8_t timer0_pin_mask;
#endif

volatile static int32_t timer1_toggle_count;
volatile static uint8_t *timer1_pin_port;
volatile static uint8_t timer1_pin_mask;

#if !defined(__AVR_ATmega32U4__)
volatile static int32_t timer2_toggle_count;
volatile static uint8_t *timer2_pin_port;
volatile static uint8_t timer2_pin_mask;
#else
volatile static int32_t timer3_toggle_count;
volatile static uint8_t *timer3_pin_port;
volatile static uint8_t timer3_pin_mask;
...
volatile static int32_t timer4_toggle_count;
volatile static uint8_t *timer4_pin_port;
volatile static uint8_t timer4_pin_mask;
#endif
...
volatile static uint8_t *timer4_pin_port;
volatile static uint8_t timer4_pin_mask;
volatile static int32_t timer5_toggle_count;
volatile static uint8_t *timer5_pin_port;
volatile static uint8_t timer5_pin_mask;
#endif
