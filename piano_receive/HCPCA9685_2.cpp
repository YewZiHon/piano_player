...
HCPCA9685_2::HCPCA9685_2(byte I2CAdd)
{
	_I2CAdd = I2CAdd;
}
...
void HCPCA9685_2::Init(boolean Mode)
{
	Wire.begin();
...
void HCPCA9685_2::Sleep(boolean Mode)
{
...
void HCPCA9685_2::SetPeriodFreq(unsigned int Freq)
{
...
void HCPCA9685_2::SetPreScaller(byte Period)
{
...
void HCPCA9685_2::Servo(byte Chan, unsigned int Pos)
{
...
/* Sets the turn ON time and OFF time for one of the 15 PWM outputs where:
   ...
   On_Time is the point at which to turn the output ON within the cycle period. Valid values are
    ...
    Off_Time is the point at which to turn the output OFF within the cycle period. Valid values are
		0 to 4095 (decimal)
*/
void HCPCA9685_2::Output(byte Chan, unsigned int On_Time, unsigned int Off_Time)
{
  if(Chan > 15)
    Chan = 15;
...
/* Sets the turn ON time and OFF time for ALL of the 15 PWM outputs where:
   ...
   On_Time is the point at which to turn the outputs ON within the cycle period. Valid values are
    ...
    Off_Time is the point at which to turn the outputs OFF within the cycle period. Valid values are
		0 to 4095 (decimal) */
void HCPCA9685_2::Output(unsigned int On_Time, unsigned int Off_Time)
{
  Wire.beginTransmission(_I2CAdd); 
...
/* Sets the turn ON time for one of the 15 PWM outputs where:
   ...
   Time is the point at which to turn the output on within the cycle period. Valid values are
		0 to 4095 (decimal) */
void HCPCA9685_2::OutputOnTime(byte Chan, unsigned int Time)
{
  if(Chan > 15)
    Chan = 15;
  Chan = LED0_ON_L + (Chan << 2);
...
/* Sets the turn OFF time for one of the 15 PWM outputs where:
   ...
   Time is the point at which to turn the output off within the cycle period. Valid values are
		0 to 4095 (decimal) */
void HCPCA9685_2::OutputOffTime(byte Chan, unsigned int Time)
{
  if(Chan > 15)
    Chan = 15;
...
void HCPCA9685_2::OutputNotEnableState(byte State)
{
...
void HCPCA9685_2::OutputDrivers(boolean Mode)
{
  byte Data = I2CReadReg(MODE2);
...
void HCPCA9685_2::OCH(boolean Mode)
{
  byte Data = I2CReadReg(MODE2);
...
void HCPCA9685_2::Invert(boolean Mode)
{
  byte Data = I2CReadReg(MODE2);
...
void HCPCA9685_2::Enable_Sub1(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_2::Enable_Sub2(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_2::Enable_Sub3(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_2::Enable_AllCall(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_2::SetSubAddress(byte SubAddress, byte Address)
{
...
void HCPCA9685_2::SetAllCallAddress(byte Address)
{
...
void HCPCA9685_2::I2CWriteReg(byte Register, byte Data)
{
  Wire.beginTransmission(_I2CAdd); 
  Wire.write(Register);
  Wire.write(Data); 
...
byte HCPCA9685_2::I2CReadReg(byte Register)
{
  byte Data;
  Wire.beginTransmission(_I2CAdd); 
  Wire.write(Register);
...
void HCPCA9685_2::_AutoIncrement(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
