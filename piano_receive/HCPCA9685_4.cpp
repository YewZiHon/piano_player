...
HCPCA9685_4::HCPCA9685_4(byte I2CAdd)
{
	_I2CAdd = I2CAdd;
}
...
void HCPCA9685_4::Init(boolean Mode)
{
	Wire.begin();
...
void HCPCA9685_4::Sleep(boolean Mode)
{
...
void HCPCA9685_4::SetPeriodFreq(unsigned int Freq)
{
...
void HCPCA9685_4::SetPreScaller(byte Period)
{
...
void HCPCA9685_4::Servo(byte Chan, unsigned int Pos)
{
...
void HCPCA9685_4::Output(byte Chan, unsigned int On_Time, unsigned int Off_Time)
{
  if(Chan > 15)
    Chan = 15;
...
void HCPCA9685_4::Output(unsigned int On_Time, unsigned int Off_Time)
{
  Wire.beginTransmission(_I2CAdd); 
...
void HCPCA9685_4::OutputOnTime(byte Chan, unsigned int Time)
{
  if(Chan > 15)
    Chan = 15;
  Chan = LED0_ON_L + (Chan << 2);
...
void HCPCA9685_4::OutputOffTime(byte Chan, unsigned int Time)
{
  if(Chan > 15)
    Chan = 15;
...
void HCPCA9685_4::OutputNotEnableState(byte State)
{
...
void HCPCA9685_4::OutputDrivers(boolean Mode)
{
  byte Data = I2CReadReg(MODE2);
...
void HCPCA9685_4::OCH(boolean Mode)
{
  byte Data = I2CReadReg(MODE2);
...
void HCPCA9685_4::Invert(boolean Mode)
{
  byte Data = I2CReadReg(MODE2);
...
void HCPCA9685_4::Enable_Sub1(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_4::Enable_Sub2(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_4::Enable_Sub3(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_4::Enable_AllCall(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
...
void HCPCA9685_4::SetSubAddress(byte SubAddress, byte Address)
{
...
void HCPCA9685_4::SetAllCallAddress(byte Address)
{
...
void HCPCA9685_4::I2CWriteReg(byte Register, byte Data)
{
  Wire.beginTransmission(_I2CAdd); 
  Wire.write(Register);
  Wire.write(Data); 
...
byte HCPCA9685_4::I2CReadReg(byte Register)
{
  byte Data;
  Wire.beginTransmission(_I2CAdd); 
  Wire.write(Register);
...
void HCPCA9685_4::_AutoIncrement(boolean Mode)
{
  byte Data = I2CReadReg(MODE1);
